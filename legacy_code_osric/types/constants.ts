...
export const RULE_NAMES = {
  ...
  TWO_WEAPON_ELIGIBILITY: 'two-weapon-eligibility',
  CRITICAL_HITS: 'critical-hits',
  MULTIPLE_ATTACKS: 'multiple-attacks',
  ATTACK_PRECEDENCE: 'attack-precedence',
  ...
  MOUNTED_COMBAT: 'mounted-combat',
  MOUNTED_COMBAT_ELIGIBILITY: 'mounted-combat-eligibility',
  MOUNTED_CHARGE: 'mounted-charge',
  AERIAL_COMBAT: 'aerial-combat',
  AERIAL_MOVEMENT: 'aerial-movement',
  UNDERWATER_COMBAT: 'underwater-combat',
  UNDERWATER_MOVEMENT: 'underwater-movement',
  DIVE_ATTACK: 'dive-attack',
  DISMOUNT: 'dismount',
  ARMOR_CATEGORY: 'armor-category',
  WEAPON_TYPE: 'weapon-type',
  WEAPON_VS_ARMOR: 'weapon-vs-armor',
  ...
  SPELL_COMPONENT_MANAGEMENT: 'spell-component-management',
  ...
  MAGIC_ITEM_SAVING_THROW: 'magic-item-saving-throw',
  MAGIC_ITEM_CHARGE_CALCULATION: 'magic-item-charge-calculation',
  MAGIC_ITEM_CHARGE_USAGE: 'magic-item-charge-usage',
  SCROLL_CREATION: 'scroll-creation',
  SPELL_RESEARCH: 'spell-research',
  ADVANCED_SPELL_RESEARCH: 'advanced-spell-research',
  SPELL_RESEARCH_REQUIREMENTS: 'spell-research-requirements',
  SPELL_RESEARCH_START: 'spell-research-start',
  SPELL_RESEARCH_PROGRESS: 'spell-research-progress',
  SPELL_RESEARCH_SUCCESS: 'spell-research-success',
